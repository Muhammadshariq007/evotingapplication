...
<div class="mainBg">
    <div class="innerform">
        ...
        @if($status == 'open')
            ...
            <div class="form-group d-flex flex-wrap gap-2">
                <div class="form-check">
                  <input class="form-check-input onchangeRadio" type="radio" name="votetype" id="localVoters" value="local" checked onchange="onchangeRadio(this)">
                  <label class="form-check-label" for="localVoters">
                    Pakistani Voters
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input onchangeRadio" type="radio" name="votetype" id="internaltionVoters"  value="international" onchange="onchangeRadio(this)">
            ...
            <div class="form-group">
                ...
                <input type="text" name="mobileNo" id="phone" class="form-control typechange" placeholder="XXXXXXXXXXX" />
            </div>
        ...
        <script>
            ...
            let remainingTime = {{ $remainingTime }}; // Time in seconds
